#ifndef FMP4CONVERTER_H
#define FMP4CONVERTER_H
...
private:
    ...
    // fMP4特有的成员
    std::vector<AP4_Sample> m_samples;
    AP4_UI64 m_base_media_decode_time;
